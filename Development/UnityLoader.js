...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'forWebGL.data';
    var REMOTE_PACKAGE_BASE = 'forWebGL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5371667;
      var PACKAGE_UUID = '02788234-c01d-4483-958f-79343092252b';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3008005, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3008005, 3008024, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3008024, 3008222, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(3008222, 4469070, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4469070, 5344042, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5344042, 5371667, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_forWebGL.data');

    };
    Module['addRunDependency']('datafile_forWebGL.data');
